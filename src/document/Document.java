...
public abstract class Document {
	...
	public double getFleschScore() {
		...
		int noOfWords = getNumWords();
		int noOfSentences = getNumSentences();
		int noOfSyllables = getNumSyllables();

		beforeTime = System.nanoTime();
		double fleschScore = 206.835 - (1.015 * ((double) noOfWords / (double) noOfSentences));
		fleschScore -= (84.6 * ((double) noOfSyllables / (double) noOfWords));
